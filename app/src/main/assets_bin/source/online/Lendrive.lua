...
-- on 2021/12/7 v1.0 created
-- on 2021/12/9 v1.2 changelog: fix cover image selector, add trailer elements.

baseUrl = "https://194.163.183.129/"

latestUpdateUrl = "%s/page/%s"
latestSelector = "div.widget_senction div.widget-title:contains(Episode Terbaru) + div.post-show div.thumb"
...
function fetchLatestUpdate(document)
    ...
    episode = document.select("dtitle").text()
